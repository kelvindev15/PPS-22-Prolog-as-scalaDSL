...
object TuPrologFactoryMethods: 
   ...
   * 
   * @param functor the struct functor's name.
   * @param terms the arguments of the struct.
   */
   ...
   * 
   * @param body1 first argument of the directive
   * @param bodies other arguments of the directive
   */
   ...
   * 
   * @param value the int value of the numeric constant.
   */
  def ktNumOf(value: Int): KNumeric = KNumeric.of(value)

  /** Returns a tuProlog [[KNumeric]] from a double value.
   *
   * @param value the double value of the numeric constant.
   */
   ...
   * 
   * @param clauses the clauses forming the theory.
   */
