...
trait Solver:
   ...
   * @return an iterator over the program's [[Solution]]s.
   */
   ...
   *
   * @param program the program to solve.
   * @return a lazy list of the program's [[Solution]]s.
   */
   ...
   *
   * @param program the program to solve.
   * @return a list of the program's [[Solution]]s.
   */
...
object Solver:
  ...
  /** Solves a program using a solver that is either provided as a context parameter,
   *  found as a given instance or by using the default one ([[TuPrologClassicSolver]]).
   *
   * @param solver the solver that should be used.
   * @param prologProgram the program to solve.
   * @return an iterator over the [[Solution]]s of the program.
   */
  ...
  /** Solves the goal on program with an empty theory using a solver that is either provided as a context parameter,
   * found as a given instance or by using the default one ([[TuPrologClassicSolver]]).
   *
   * @param solver        the solver that should be used.
   * @param query the goal to be solved.
   * @return an iterator over the program's [[Solution]]s.
   */
