...
import io.github.kelvindev15.prolog.utils.{TermConvertible, TermVisitor, ToStringTermVisitor}
...
trait Term extends TermConvertible with Visitable:
  ...
  /** Return this term. Inheritors should use possibly only [[Variable]]s, [[Constants]]s and [[Structs]]. */
  def asTerm: Term
