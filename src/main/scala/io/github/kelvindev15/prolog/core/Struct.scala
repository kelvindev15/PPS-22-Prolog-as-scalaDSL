...
object Struct:
  ...
  /** Returns a quoted string to make it adhere to Prolog's atom syntax,
   * or the provided string if it is already compliant.
   * 
   * @param functor the string to possibly quote.
   */
   ...
   * @param args the arguments of the struct.
   */
  ...
  object Indicator:
     ...
     * 
     * @param indicatedFunctor the functor of the indicated predicate.
     * @param indicatedArity the arity of the indicated predicate.
     */
  ...
  object Rule:
     ...
     * @param goals the goals of the rule.
     */
    def apply(head: Struct, goals: Term*): Rule = RuleImpl(head, Conjunction.wrapIfNecessary(goals*))
  ...
  object Fact:
     ...
     * 
     * @param head the [[Struct]] representing the fact.
     */
